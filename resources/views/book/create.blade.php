                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('books.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input value="{{ old('publisher') }}" type="text" id="publisher" name="publisher"
                                class="w-full px-4 py-2 rounded-md bg-gray-700 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            @error('publisher')
                                <p class="text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <input value="{{ old('published_at') }}" type="date" id="published_at"
                                name="published_at"
                                class="w-full px-4 py-2 rounded-md bg-gray-700 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            @error('published_at')
                                <p class="text-red-400">{{ $message }}</p>
                        ...
                        <button type="submit"
                            class="px-6 py-2 bg-indigo-500 text-white rounded-md hover:bg-indigo-600">Submit</button>
                    </form>
